...
;(function() {
  function navigate(dir) {
    var link = document.querySelector(
      '.publication__nav__' + dir + ' a.publication__nav__link'
    )
    if (!link) return
  ...
  function isEditing(e) {
    return (
      ...
      (document.activeElement &&
        editableElementTagNames.indexOf(document.activeElement.tagName) > -1)
    )
  }
  ...
  function registerNavEvents() {
    ...
    var infoButton = document.querySelector(
      '.header__item__toggle--info button'
    )
