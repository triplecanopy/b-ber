...
import HtmlToXml from './HtmlToXml'

/**
 * @class HtmlToPrintReadyHtml
 * @extends HtmlToXml
 */
class HtmlToPrintReadyHtml extends HtmlToXml {
            ...
            const printer = new htmlparser.Parser(
                {
                    onopentag(name, attrs) {
                        ...
                        const tag = [name]
                        // TODO: remove for..of
                        // @issue: https://github.com/triplecanopy/b-ber/issues/205
