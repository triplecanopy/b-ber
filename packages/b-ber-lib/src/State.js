...
function dynamicPageTmpl() { throw new Error('[state.templates#dynamicPageTmpl] has not been initialized in b-ber-modifiers/inject') }
function dynamicPageHead() { throw new Error('[state.templates#dynamicPageHead] has not been initialized in b-ber-modifiers/inject') }
function dynamicPageTail() { throw new Error('[state.templates#dynamicPageTail] has not been initialized in b-ber-modifiers/inject') }
