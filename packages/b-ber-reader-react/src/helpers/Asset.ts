...
class Asset {
  ...
  static createHash(seed: unknown): string {
    let hash = 0
    let chr: number
  ...
  static appendBookStyles(css: string, hash: string): void {
  ...
  static removeBookStyles(hash: string): void {
  ...
  static convertToReactAttrs(attrs: Record<string, any>): Record<string, any> {
