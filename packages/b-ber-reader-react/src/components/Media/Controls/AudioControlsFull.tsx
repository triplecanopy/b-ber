...
type AudioControlsFullProps = Omit<
  MediaControlsChildProps,
  'mediaType' | 'config'
>

function AudioControlsFullStacked(props: AudioControlsFullProps) {
  return (
...
function AudioControlsFull(props: AudioControlsFullProps) {
  return (
    <>
      <MediaButtonSeekBack timeBack={props.timeBack} />
      <MediaButtonPlayPause
...
function AudioControls(props: AudioControlsFullProps) {
