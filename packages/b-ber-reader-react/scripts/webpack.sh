...
#
# npm run webpack:src
#   npm run clean && NODE_ENV=development webpack --config webpack/config.development.js --progress --profile --color --mode=development -w --verbose
#
#
# Running in production
#
# npm run webpack:dist
#   npm run clean && NODE_ENV=production webpack --config webpack/config.production.js --progress --profile --color --mode=production
#
#
# Running in production with custom Webpack config
#
# npm run webpack:dist ./webpack/custom.config.js
#   npm run clean && NODE_ENV=production webpack --config ./webpack/custom.config.js --progress --profile --color --mode=production
#
...
npm run clean
NODE_ENV="$ENV" webpack --config "$CONFIG" --progress --profile --color "$FLAGS"