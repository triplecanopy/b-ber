# TASK-026: Fix infinite spinner on window resize
...
restarting the *old* chapter's `Ultimate` during navigation — see TASK-027 /
...
- This is a targeted fix. The deeper, more robust solution is TASK-027 (give the
