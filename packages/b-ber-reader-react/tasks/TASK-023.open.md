# TASK-023: Harden Ultimate layout-stability detection
...
- This is the foundation for TASK-022 and TASK-024 — both now key off the
...
- `Ultimate` still polls `offsetLeft`; replacing polling entirely is tracked
  separately in TASK-028 (BUG 9). Polling is the pragmatic detector here because
