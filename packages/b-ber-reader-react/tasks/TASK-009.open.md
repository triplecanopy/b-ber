...
- This task covers Phase 1 only. Phases 2–5 are tracked separately: TASK-010
  (Phase 2 verification), TASK-008/Phase 3 items in PLAN.md, TASK-013 (Phase 4),
  TASK-014 (Phase 5).
