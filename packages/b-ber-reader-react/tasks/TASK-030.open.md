# TASK-030: Deep-linking to a spreadIndex does not navigate to that spread
...
Discovered while reproducing TASK-029: deep-linking to `spreadIndex=11` rendered
...
- Independent of the spread layout bugs (TASK-029) but commonly hit together when
