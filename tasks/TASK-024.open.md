...
- [ ] TASK-025: Convert `b-ber-grammar-*` (16 packages)
- [ ] TASK-026: Convert `b-ber-parser-*` (5 packages)
- [ ] TASK-027: Convert `b-ber-templates`
- [ ] TASK-028: Convert `b-ber-markdown-renderer` (includes hljs vendor replacement)
