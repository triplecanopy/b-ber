...
**GitHub Issue:** #634 — https://github.com/triplecanopy/b-ber/issues/634
...
- [ ] **Update epic [#615](https://github.com/triplecanopy/b-ber/issues/615)** —
      note that the `~` removal closes the TASK-076 findings recommendation.
