...
- [x] Write `docs/diagrams/06-tooling-matrix.md`
...
- [x] Write `docs/diagrams/07-external-dependencies.md`
...
- [x] Create `docs/diagrams/pkg/` subdirectory with one file per package
  ...
  - Grammar/parser packages can share a template and be filled in bulk
    (deferred: grammar/parser pages not created in this iteration — they
    share identical tooling and structure; add in a follow-up when per-package
    issues diverge enough to warrant individual pages)
- [x] Add `## See also` cross-reference footers to diagrams 01–05
- [x] Add a `docs/diagrams/README.md` as an index (diagram title, one-line
...
- [ ] (Stretch) Write `scripts/update-diagrams.js` to generate/refresh the
      ...
      (deferred: PRD explicitly marks this as a stretch goal / separate task)
...
Files added:
- `docs/diagrams/README.md` — index of all diagrams with one-line descriptions
- `docs/diagrams/06-tooling-matrix.md` — per-package tooling audit (Node target,
  transpiler, test transform, build output, bundler, TS status) plus post-TASK-008
  expected state and transpiler architecture diagram
- `docs/diagrams/07-external-dependencies.md` — version audit grouped by concern
  (test tooling, build tooling, TypeScript, linting, Node stdlib replacements,
  individual lodash packages, React/UI, consolidation candidates, version conflicts)
- `docs/diagrams/pkg/b-ber-lib.md`
- `docs/diagrams/pkg/b-ber-tasks.md`
- `docs/diagrams/pkg/b-ber-cli.md`
- `docs/diagrams/pkg/b-ber-reader-react.md`
- `docs/diagrams/pkg/b-ber-markdown-renderer.md`

Files modified (cross-reference footers added):
- `docs/diagrams/01-architecture-overview.md`
- `docs/diagrams/02-package-dependencies.md`
- `docs/diagrams/03-build-pipeline.md`
- `docs/diagrams/04-markdown-rendering-layer.md`
- `docs/diagrams/05-reader-react.md`

Deferred to follow-up:
- Grammar/parser per-package pages: all 19 grammar+parser packages share
  identical tooling (Babel 7, babel-jest ^24, no bundler, dist/ output);
  individual pages add little value until their issues diverge. Add when needed.
- `scripts/update-diagrams.js` generator: PRD explicitly marks this as a
  stretch goal and separate task.
