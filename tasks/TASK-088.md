...
**GitHub Issue:** #630 — https://github.com/triplecanopy/b-ber/issues/630
**Phase:** Bug Fixes
**Created:** 2026-06-06
...
This is distinct from the timing/staleness fixes in TASK-081/023/024 — those are
...
blank to the measurement cascade now addressed by TASK-081's convergence loop (a
...
flow. Verify the intermediate blank is gone after TASK-081 before scoping the
...
- [ ] `npm test`; commit; PR with `Closes #630`
...
- Related: TASK-081/023/024 (timing fixes this builds on), TASK-089 (deep-link).
