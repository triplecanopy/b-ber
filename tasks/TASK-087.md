...
**GitHub Issue:** #629 — https://github.com/triplecanopy/b-ber/issues/629
**Phase:** Modernization
**Created:** 2026-06-06
...
"never settles" / "settles too early" bugs. TASK-082 strengthened the polling
...
- Consolidate the three settle-detectors into a single authoritative
  ...
  `with-node-position` all subscribe to (ties in with TASK-086).
...
- [ ] `npm test`; commit; PR with `Closes #629`

## Notes

- Lower priority than the correctness fixes (TASK-081 through TASK-085): the
  current polling works once TASK-082's criterion is in place; this is a
  standards/cleanliness and architecture improvement.
- Related: TASK-082 (interim criterion hardening), TASK-086 (single loading/
  settled signal).
