...
//       return YAML.load(path.join(this.src, 'metadata.yml'), (resp) => {
//         this.bookmeta = resp
//         resolve()
//       })
//     })
...
//     console.log('--- createManifestObjectFromAssets')
//     return new Promise((resolve, reject) =>
...
//       .then(this.createManifestAndMetadataFromTemplates)

//       // create the manifest and metadata from templating strings.manifest and
//       // strings.metadata
//       .then(this.createManifestAndMetadataXML)
