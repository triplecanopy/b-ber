...
// API to transform YAML to/from JSON and JavaScript objects. Includes
// convenience wrappers for loading local files. Uses
// [`js-yaml`](https://www.npmjs.com/package/js-yaml), defaulting always
